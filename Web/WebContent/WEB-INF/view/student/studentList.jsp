	    ...
	    $('#dataList').datagrid({ 
	        ...
	        columns: [[  
				{field:'chk',checkbox: true,width:50},
 		        ...
 		        {field:'number',title:'学号',width:120, sortable: true},
				{field:'name',title:'姓名',width:120},
				{field:'sex',title:'性别',width:60},
 		        {field:'one',title:'第一天',width:60},
				{field:'two',title:'第二天',width:60},
				{field:'three',title:'第三天',width:60},
				{field:'four',title:'第四天',width:60},
				{field:'five',title:'第五天',width:60},
				{field:'last_week',title:'上周评价',width:60},
				{field:'flag',title:'状态',width:60},
